...
namespace Reka
{
    public partial class SpeechClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Reka.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Reka.AutoSDKHttpResponse<global::Reka.TranscribeOrTranslateResponse>> TranscribeOrTranslateAsResponseAsync(
                ...
                else
                {
                    await global::Reka.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 422)
                            {
                                ...
                                throw global::Reka.ApiException<global::Reka.HTTPValidationError>.Create(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Reka.TranscribeOrTranslateResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Reka.AutoSDKHttpResponse<global::Reka.TranscribeOrTranslateResponse>(
                                        statusCode: __response.StatusCode,
                                ...
                                {
                                    throw global::Reka.ApiException.Create(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Reka.TranscribeOrTranslateResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
