...
namespace Reka.Vision
{
    public partial class InferenceClient
    {
        ...
        private static readonly global::Reka.Vision.EndPointSecurityRequirement s_SubmitImageToVideoSecurityRequirement0 =
        ...
        private static readonly global::Reka.Vision.EndPointSecurityRequirement[] s_SubmitImageToVideoSecurityRequirements =
            new global::Reka.Vision.EndPointSecurityRequirement[]
            {                s_SubmitImageToVideoSecurityRequirement0,
            };
        partial void PrepareSubmitImageToVideoArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::Reka.Vision.ImageToVideoModelId model,
            ref string? idempotencyKey,
            global::Reka.Vision.ImageToVideoSubmitRequest request);
        partial void PrepareSubmitImageToVideoRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Reka.Vision.ImageToVideoModelId model,
            string? idempotencyKey,
            global::Reka.Vision.ImageToVideoSubmitRequest request);
        partial void ProcessSubmitImageToVideoResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessSubmitImageToVideoResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Reka.Vision.SubmitResponse> SubmitImageToVideoAsync(
            global::Reka.Vision.ImageToVideoModelId model,
        ...
        {
            var __response = await SubmitImageToVideoAsResponseAsync(
                model: model,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Reka.Vision.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Reka.Vision.AutoSDKHttpResponse<global::Reka.Vision.SubmitResponse>> SubmitImageToVideoAsResponseAsync(
            global::Reka.Vision.ImageToVideoModelId model,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareSubmitImageToVideoArguments(
            ...
            var __authorizations = global::Reka.Vision.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_SubmitImageToVideoSecurityRequirements,
                operationName: "SubmitImageToVideoAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Reka.Vision.PathBuilder(
                                path: $"/v2/inference/{(global::System.Uri.EscapeDataString(model.ToValueString()))}/image-to-video",
            ...
            __httpRequest.Headers.TryAddWithoutValidation("Idempotency-Key", __idempotencyKey);
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareSubmitImageToVideoRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Reka.Vision.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Reka.Vision.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "SubmitImageToVideoAsync",
                                pathTemplate: "$\"/v2/inference/{(global::System.Uri.EscapeDataString(model.ToValueString()))}/image-to-video\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessSubmitImageToVideoResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Reka.Vision.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessSubmitImageToVideoResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::Reka.Vision.SubmitResponse> SubmitImageToVideoAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Reka.Vision.ImageToVideoSubmitRequest
            {
                Input = input,
                WebhookUrl = webhookUrl,
            };

            return await SubmitImageToVideoAsync(
                model: model,
                idempotencyKey: idempotencyKey,
                request: __request,
                requestOptions: requestOptions,
