...
namespace Reka.Vision
{
    public partial class ClipsClient
    {
        ...
        private static readonly global::Reka.Vision.EndPointSecurityRequirement s_CreateReelV1ClipsPostSecurityRequirement0 =
        ...
        private static readonly global::Reka.Vision.EndPointSecurityRequirement[] s_CreateReelV1ClipsPostSecurityRequirements =
            new global::Reka.Vision.EndPointSecurityRequirement[]
            {                s_CreateReelV1ClipsPostSecurityRequirement0,
            };
        partial void PrepareCreateReelV1ClipsPostArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::Reka.Vision.ReelQuality? reelQuality,
            ref bool? forceVllmWhisperAsr,
            global::Reka.Vision.ClipRequest request);
        partial void PrepareCreateReelV1ClipsPostRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Reka.Vision.ReelQuality? reelQuality,
            bool? forceVllmWhisperAsr,
            global::Reka.Vision.ClipRequest request);
        partial void ProcessCreateReelV1ClipsPostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateReelV1ClipsPostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> CreateReelV1ClipsPostAsync(
        ...
        {
            var __response = await CreateReelV1ClipsPostAsResponseAsync(

                request: request,
                reelQuality: reelQuality,
                forceVllmWhisperAsr: forceVllmWhisperAsr,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Reka.Vision.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Reka.Vision.AutoSDKHttpResponse<string>> CreateReelV1ClipsPostAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateReelV1ClipsPostArguments(
                httpClient: HttpClient,
                reelQuality: ref reelQuality,
                forceVllmWhisperAsr: ref forceVllmWhisperAsr,
                request: request);


            var __authorizations = global::Reka.Vision.EndPointSecurityResolver.ResolveAuthorizations(
                availableAuthorizations: Authorizations,
                securityRequirements: s_CreateReelV1ClipsPostSecurityRequirements,
                operationName: "CreateReelV1ClipsPostAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            __pathBuilder
                                .AddOptionalParameter("reel_quality", reelQuality?.ToValueString())
                                .AddOptionalParameter("force_vllm_whisper_asr", forceVllmWhisperAsr?.ToString().ToLowerInvariant())
                                ;
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateReelV1ClipsPostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Reka.Vision.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Reka.Vision.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "CreateReelV1ClipsPost",
                                methodName: "CreateReelV1ClipsPostAsync",
                                pathTemplate: "\"/v1/clips\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateReelV1ClipsPostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Reka.Vision.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateReelV1ClipsPostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    return new global::Reka.Vision.AutoSDKHttpResponse<string>(
        ...
        public async global::System.Threading.Tasks.Task<string> CreateReelV1ClipsPostAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Reka.Vision.ClipRequest
            {
                VideoUrls = videoUrls,
                Prompt = prompt,
            ...
            return await CreateReelV1ClipsPostAsync(
                reelQuality: reelQuality,
                forceVllmWhisperAsr: forceVllmWhisperAsr,
                request: __request,
                requestOptions: requestOptions,
