...
namespace Reka.Vision
{
    public partial class V2Client
    {
        ...
        private static readonly global::Reka.Vision.EndPointSecurityRequirement s_TriggerTranscriptV2VideosVideoIdFeaturesTranscriptPostSecurityRequirement0 =
        ...
        private static readonly global::Reka.Vision.EndPointSecurityRequirement[] s_TriggerTranscriptV2VideosVideoIdFeaturesTranscriptPostSecurityRequirements =
            new global::Reka.Vision.EndPointSecurityRequirement[]
            {                s_TriggerTranscriptV2VideosVideoIdFeaturesTranscriptPostSecurityRequirement0,
            };
        partial void PrepareTriggerTranscriptV2VideosVideoIdFeaturesTranscriptPostArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string videoId,
            global::Reka.Vision.TranscriptTriggerRequest request);
        partial void PrepareTriggerTranscriptV2VideosVideoIdFeaturesTranscriptPostRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string videoId,
            global::Reka.Vision.TranscriptTriggerRequest request);
        partial void ProcessTriggerTranscriptV2VideosVideoIdFeaturesTranscriptPostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessTriggerTranscriptV2VideosVideoIdFeaturesTranscriptPostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Reka.Vision.FeatureTriggerResponse> TriggerTranscriptV2VideosVideoIdFeaturesTranscriptPostAsync(
            string videoId,
        ...
        {
            var __response = await TriggerTranscriptV2VideosVideoIdFeaturesTranscriptPostAsResponseAsync(
                videoId: videoId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Reka.Vision.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Reka.Vision.AutoSDKHttpResponse<global::Reka.Vision.FeatureTriggerResponse>> TriggerTranscriptV2VideosVideoIdFeaturesTranscriptPostAsResponseAsync(
            string videoId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareTriggerTranscriptV2VideosVideoIdFeaturesTranscriptPostArguments(
            ...
            var __authorizations = global::Reka.Vision.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_TriggerTranscriptV2VideosVideoIdFeaturesTranscriptPostSecurityRequirements,
                operationName: "TriggerTranscriptV2VideosVideoIdFeaturesTranscriptPostAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareTriggerTranscriptV2VideosVideoIdFeaturesTranscriptPostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Reka.Vision.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Reka.Vision.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "TriggerTranscriptV2VideosVideoIdFeaturesTranscriptPost",
                                methodName: "TriggerTranscriptV2VideosVideoIdFeaturesTranscriptPostAsync",
                                pathTemplate: "$\"/v2/videos/{videoId}/features/transcript\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessTriggerTranscriptV2VideosVideoIdFeaturesTranscriptPostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Reka.Vision.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessTriggerTranscriptV2VideosVideoIdFeaturesTranscriptPostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::Reka.Vision.FeatureTriggerResponse> TriggerTranscriptV2VideosVideoIdFeaturesTranscriptPostAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Reka.Vision.TranscriptTriggerRequest
            {
                Force = force,
                ChunkingConfig = chunkingConfig,
                DownsampleVideo = downsampleVideo,
            };

            return await TriggerTranscriptV2VideosVideoIdFeaturesTranscriptPostAsync(
                videoId: videoId,
                request: __request,
                requestOptions: requestOptions,
