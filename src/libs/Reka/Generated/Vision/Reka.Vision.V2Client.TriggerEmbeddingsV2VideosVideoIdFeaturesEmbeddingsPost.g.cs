...
namespace Reka.Vision
{
    public partial class V2Client
    {
        ...
        private static readonly global::Reka.Vision.EndPointSecurityRequirement s_TriggerEmbeddingsV2VideosVideoIdFeaturesEmbeddingsPostSecurityRequirement0 =
        ...
        private static readonly global::Reka.Vision.EndPointSecurityRequirement[] s_TriggerEmbeddingsV2VideosVideoIdFeaturesEmbeddingsPostSecurityRequirements =
            new global::Reka.Vision.EndPointSecurityRequirement[]
            {                s_TriggerEmbeddingsV2VideosVideoIdFeaturesEmbeddingsPostSecurityRequirement0,
            };
        partial void PrepareTriggerEmbeddingsV2VideosVideoIdFeaturesEmbeddingsPostArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string videoId,
            global::Reka.Vision.FeatureTriggerRequest request);
        partial void PrepareTriggerEmbeddingsV2VideosVideoIdFeaturesEmbeddingsPostRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string videoId,
            global::Reka.Vision.FeatureTriggerRequest request);
        partial void ProcessTriggerEmbeddingsV2VideosVideoIdFeaturesEmbeddingsPostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessTriggerEmbeddingsV2VideosVideoIdFeaturesEmbeddingsPostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Reka.Vision.FeatureTriggerResponse> TriggerEmbeddingsV2VideosVideoIdFeaturesEmbeddingsPostAsync(
            string videoId,
        ...
        {
            var __response = await TriggerEmbeddingsV2VideosVideoIdFeaturesEmbeddingsPostAsResponseAsync(
                videoId: videoId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Reka.Vision.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Reka.Vision.AutoSDKHttpResponse<global::Reka.Vision.FeatureTriggerResponse>> TriggerEmbeddingsV2VideosVideoIdFeaturesEmbeddingsPostAsResponseAsync(
            string videoId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareTriggerEmbeddingsV2VideosVideoIdFeaturesEmbeddingsPostArguments(
            ...
            var __authorizations = global::Reka.Vision.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_TriggerEmbeddingsV2VideosVideoIdFeaturesEmbeddingsPostSecurityRequirements,
                operationName: "TriggerEmbeddingsV2VideosVideoIdFeaturesEmbeddingsPostAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareTriggerEmbeddingsV2VideosVideoIdFeaturesEmbeddingsPostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Reka.Vision.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Reka.Vision.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "TriggerEmbeddingsV2VideosVideoIdFeaturesEmbeddingsPost",
                                methodName: "TriggerEmbeddingsV2VideosVideoIdFeaturesEmbeddingsPostAsync",
                                pathTemplate: "$\"/v2/videos/{videoId}/features/embeddings\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessTriggerEmbeddingsV2VideosVideoIdFeaturesEmbeddingsPostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Reka.Vision.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessTriggerEmbeddingsV2VideosVideoIdFeaturesEmbeddingsPostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::Reka.Vision.FeatureTriggerResponse> TriggerEmbeddingsV2VideosVideoIdFeaturesEmbeddingsPostAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Reka.Vision.FeatureTriggerRequest
            {
                Force = force,
            };

            return await TriggerEmbeddingsV2VideosVideoIdFeaturesEmbeddingsPostAsync(
                videoId: videoId,
                request: __request,
                requestOptions: requestOptions,
