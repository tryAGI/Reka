...
namespace Reka.Vision
{
    public partial class InferenceClient
    {
        ...
        private static readonly global::Reka.Vision.EndPointSecurityRequirement s_SubmitTextToImageSecurityRequirement0 =
        ...
        private static readonly global::Reka.Vision.EndPointSecurityRequirement[] s_SubmitTextToImageSecurityRequirements =
            new global::Reka.Vision.EndPointSecurityRequirement[]
            {                s_SubmitTextToImageSecurityRequirement0,
            };
        partial void PrepareSubmitTextToImageArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::Reka.Vision.TextToImageModelId model,
            ref string? idempotencyKey,
            global::Reka.Vision.TextToImageSubmitRequest request);
        partial void PrepareSubmitTextToImageRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Reka.Vision.TextToImageModelId model,
            string? idempotencyKey,
            global::Reka.Vision.TextToImageSubmitRequest request);
        partial void ProcessSubmitTextToImageResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessSubmitTextToImageResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Reka.Vision.SubmitResponse> SubmitTextToImageAsync(
            global::Reka.Vision.TextToImageModelId model,
        ...
        {
            var __response = await SubmitTextToImageAsResponseAsync(
                model: model,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Reka.Vision.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Reka.Vision.AutoSDKHttpResponse<global::Reka.Vision.SubmitResponse>> SubmitTextToImageAsResponseAsync(
            global::Reka.Vision.TextToImageModelId model,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareSubmitTextToImageArguments(
            ...
            var __authorizations = global::Reka.Vision.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_SubmitTextToImageSecurityRequirements,
                operationName: "SubmitTextToImageAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Reka.Vision.PathBuilder(
                                path: $"/v2/inference/{(global::System.Uri.EscapeDataString(model.ToValueString()))}/text-to-image",
            ...
            __httpRequest.Headers.TryAddWithoutValidation("Idempotency-Key", __idempotencyKey);
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareSubmitTextToImageRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Reka.Vision.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Reka.Vision.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "SubmitTextToImageAsync",
                                pathTemplate: "$\"/v2/inference/{(global::System.Uri.EscapeDataString(model.ToValueString()))}/text-to-image\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessSubmitTextToImageResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Reka.Vision.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessSubmitTextToImageResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await SubmitTextToImageAsync(
                model: model,
                idempotencyKey: idempotencyKey,
                request: __request,
                requestOptions: requestOptions,
