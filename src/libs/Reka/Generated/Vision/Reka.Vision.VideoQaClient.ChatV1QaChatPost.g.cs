...
{
    public partial class VideoQaClient
    {


        private static readonly global::Reka.Vision.EndPointSecurityRequirement s_ChatV1QaChatPostSecurityRequirement0 =
        ...
        private static readonly global::Reka.Vision.EndPointSecurityRequirement[] s_ChatV1QaChatPostSecurityRequirements =
            new global::Reka.Vision.EndPointSecurityRequirement[]
            {                s_ChatV1QaChatPostSecurityRequirement0,
            };
        partial void PrepareChatV1QaChatPostArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Reka.Vision.VideoQARequest request);
        partial void PrepareChatV1QaChatPostRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Reka.Vision.VideoQARequest request);
        partial void ProcessChatV1QaChatPostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessChatV1QaChatPostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Reka.Vision.VideoQAResponse> ChatV1QaChatPostAsync(

            global::Reka.Vision.VideoQARequest request,
            global::Reka.Vision.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await ChatV1QaChatPostAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Reka.Vision.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Reka.Vision.AutoSDKHttpResponse<global::Reka.Vision.VideoQAResponse>> ChatV1QaChatPostAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareChatV1QaChatPostArguments(
            ...
            var __authorizations = global::Reka.Vision.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ChatV1QaChatPostSecurityRequirements,
                operationName: "ChatV1QaChatPostAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareChatV1QaChatPostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Reka.Vision.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Reka.Vision.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ChatV1QaChatPost",
                                methodName: "ChatV1QaChatPostAsync",
                                pathTemplate: "\"/v1/qa/chat\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessChatV1QaChatPostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Reka.Vision.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessChatV1QaChatPostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Reka.Vision.VideoQAResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Reka.Vision.AutoSDKHttpResponse<global::Reka.Vision.VideoQAResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Reka.Vision.VideoQAResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Reka.Vision.VideoQAResponse> ChatV1QaChatPostAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Reka.Vision.VideoQARequest
            {
                UserId = userId,
                VideoId = videoId,
                Messages = messages,
                Stream = stream,
                ApplyTemporalPrefiltering = applyTemporalPrefiltering,
                IncludeDemoVideos = includeDemoVideos,
                UseMapReduceSummarization = useMapReduceSummarization,
            };

            return await ChatV1QaChatPostAsync(
                request: __request,
                requestOptions: requestOptions,
