...
namespace Reka.Vision
{
    public partial class ClipsClient
    {
        ...
        private static readonly global::Reka.Vision.EndPointSecurityRequirement s_ListReelsV1ClipsGetSecurityRequirement0 =
        ...
        private static readonly global::Reka.Vision.EndPointSecurityRequirement[] s_ListReelsV1ClipsGetSecurityRequirements =
            new global::Reka.Vision.EndPointSecurityRequirement[]
            {                s_ListReelsV1ClipsGetSecurityRequirement0,
            };
        partial void PrepareListReelsV1ClipsGetArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref int? offset,
            ref int? limit,
            ref string? status);
        partial void PrepareListReelsV1ClipsGetRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            int? offset,
            int? limit,
            string? status);
        partial void ProcessListReelsV1ClipsGetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessListReelsV1ClipsGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Reka.Vision.ClipListResponse> ListReelsV1ClipsGetAsync(
            int? offset = default,
            int? limit = default,
        ...
        {
            var __response = await ListReelsV1ClipsGetAsResponseAsync(
                offset: offset,
                limit: limit,
                status: status,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Reka.Vision.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Reka.Vision.AutoSDKHttpResponse<global::Reka.Vision.ClipListResponse>> ListReelsV1ClipsGetAsResponseAsync(
            int? offset = default,
            int? limit = default,
            string? status = default,
            global::Reka.Vision.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareListReelsV1ClipsGetArguments(
            ...
            var __authorizations = global::Reka.Vision.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ListReelsV1ClipsGetSecurityRequirements,
                operationName: "ListReelsV1ClipsGetAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareListReelsV1ClipsGetRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Reka.Vision.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Reka.Vision.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ListReelsV1ClipsGet",
                                methodName: "ListReelsV1ClipsGetAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessListReelsV1ClipsGetResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Reka.Vision.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessListReelsV1ClipsGetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Reka.Vision.ClipListResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Reka.Vision.AutoSDKHttpResponse<global::Reka.Vision.ClipListResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Reka.Vision.ClipListResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
