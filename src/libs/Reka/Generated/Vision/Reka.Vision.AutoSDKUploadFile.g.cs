...
namespace Reka.Vision
{
    ...
    public sealed class AutoSDKUploadFile : global::System.IDisposable
    {
            ...
            get
            {
                if (_hasStream)
                {
                    throw new global::System.InvalidOperationException(
                        $"{nameof(AutoSDKUploadFile)} was constructed with a stream; access the stream via {nameof(OpenReadStream)}() instead.");
                }
        ...
        /// Callers should not dispose the stream — it is owned by the <see cref="AutoSDKUploadFile"/> instance.
        /// </summary>
        public global::System.IO.Stream OpenReadStream()
        {
            ...
            {
                throw new global::System.InvalidOperationException(
                    $"{nameof(AutoSDKUploadFile)} was constructed with bytes; access the bytes via {nameof(Bytes)} instead.");
            }
        ...
        public static AutoSDKUploadFile FromStream(
            string filename,
            global::System.IO.Stream stream,
            string? contentType = null,
        ...
        /// </summary>
        public static AutoSDKUploadFile FromPath(
            string path,
    ...
    /// <summary>
    /// Lightweight MIME-type guesser used by <see cref="AutoSDKUploadFile"/>. Covers the file types most commonly
