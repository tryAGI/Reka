...
namespace Reka.Vision
{
    public partial class InferenceClient
    {
        ...
        private static readonly global::Reka.Vision.EndPointSecurityRequirement s_SubmitImageToBboxSecurityRequirement0 =
        ...
        private static readonly global::Reka.Vision.EndPointSecurityRequirement[] s_SubmitImageToBboxSecurityRequirements =
            new global::Reka.Vision.EndPointSecurityRequirement[]
            {                s_SubmitImageToBboxSecurityRequirement0,
            };
        partial void PrepareSubmitImageToBboxArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::Reka.Vision.ImageToBboxModelId model,
            ref string? idempotencyKey,
            global::Reka.Vision.ImageToBboxSubmitRequest request);
        partial void PrepareSubmitImageToBboxRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Reka.Vision.ImageToBboxModelId model,
            string? idempotencyKey,
            global::Reka.Vision.ImageToBboxSubmitRequest request);
        partial void ProcessSubmitImageToBboxResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessSubmitImageToBboxResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Reka.Vision.SubmitResponse> SubmitImageToBboxAsync(
            global::Reka.Vision.ImageToBboxModelId model,
        ...
        {
            var __response = await SubmitImageToBboxAsResponseAsync(
                model: model,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Reka.Vision.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Reka.Vision.AutoSDKHttpResponse<global::Reka.Vision.SubmitResponse>> SubmitImageToBboxAsResponseAsync(
            global::Reka.Vision.ImageToBboxModelId model,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareSubmitImageToBboxArguments(
            ...
            var __authorizations = global::Reka.Vision.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_SubmitImageToBboxSecurityRequirements,
                operationName: "SubmitImageToBboxAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Reka.Vision.PathBuilder(
                                path: $"/v2/inference/{(global::System.Uri.EscapeDataString(model.ToValueString()))}/image-to-bbox",
            ...
            __httpRequest.Headers.TryAddWithoutValidation("Idempotency-Key", __idempotencyKey);
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareSubmitImageToBboxRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Reka.Vision.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Reka.Vision.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "SubmitImageToBbox",
                                methodName: "SubmitImageToBboxAsync",
                                pathTemplate: "$\"/v2/inference/{(global::System.Uri.EscapeDataString(model.ToValueString()))}/image-to-bbox\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessSubmitImageToBboxResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Reka.Vision.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessSubmitImageToBboxResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::Reka.Vision.SubmitResponse> SubmitImageToBboxAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Reka.Vision.ImageToBboxSubmitRequest
            {
                Input = input,
                WebhookUrl = webhookUrl,
            };

            return await SubmitImageToBboxAsync(
                model: model,
                idempotencyKey: idempotencyKey,
                request: __request,
                requestOptions: requestOptions,
