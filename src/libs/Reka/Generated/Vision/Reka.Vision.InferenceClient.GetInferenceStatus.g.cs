...
namespace Reka.Vision
{
    public partial class InferenceClient
    {
        ...
        private static readonly global::Reka.Vision.EndPointSecurityRequirement s_GetInferenceStatusSecurityRequirement0 =
        ...
        private static readonly global::Reka.Vision.EndPointSecurityRequirement[] s_GetInferenceStatusSecurityRequirements =
            new global::Reka.Vision.EndPointSecurityRequirement[]
            {                s_GetInferenceStatusSecurityRequirement0,
            };
        partial void PrepareGetInferenceStatusArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string requestId,
            ref bool? withLogs);
        partial void PrepareGetInferenceStatusRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string requestId,
            bool? withLogs);
        partial void ProcessGetInferenceStatusResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetInferenceStatusResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Reka.Vision.StatusResponse> GetInferenceStatusAsync(
            string requestId,
            bool? withLogs = default,
            global::Reka.Vision.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GetInferenceStatusAsResponseAsync(
                requestId: requestId,
                withLogs: withLogs,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Reka.Vision.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Reka.Vision.AutoSDKHttpResponse<global::Reka.Vision.StatusResponse>> GetInferenceStatusAsResponseAsync(
            string requestId,
            bool? withLogs = default,
            global::Reka.Vision.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetInferenceStatusArguments(
                httpClient: HttpClient,
                requestId: ref requestId,
                withLogs: ref withLogs);


            var __authorizations = global::Reka.Vision.EndPointSecurityResolver.ResolveAuthorizations(
                availableAuthorizations: Authorizations,
                securityRequirements: s_GetInferenceStatusSecurityRequirements,
                operationName: "GetInferenceStatusAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Reka.Vision.PathBuilder(
                                path: $"/v2/inference/requests/{requestId}/status",
                                baseUri: HttpClient.BaseAddress);
                            __pathBuilder
                                .AddOptionalParameter("with_logs", withLogs?.ToString().ToLowerInvariant())
                                ;
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetInferenceStatusRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Reka.Vision.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Reka.Vision.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetInferenceStatus",
                                methodName: "GetInferenceStatusAsync",
                                pathTemplate: "$\"/v2/inference/requests/{requestId}/status\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetInferenceStatusResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Reka.Vision.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetInferenceStatusResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Reka.Vision.StatusResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Reka.Vision.AutoSDKHttpResponse<global::Reka.Vision.StatusResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Reka.Vision.StatusResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
